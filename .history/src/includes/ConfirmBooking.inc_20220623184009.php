<?php
    ...
    foreach ($SelectedHotel as $Hotel => $Booking) {
        ...
        $body .= '  <p>Greetings '.$Booking["name"] .' '.$Booking["surname"].'</p>
                    ...
                    <br>
                    <p>Nightly Rate: '.$Booking["rate"].' ZAR / day</p>
                    <p>Check In: '.$Booking["checkIn"].'</p>
                    <p>Check Out: '.$Booking["checkOut"].'</p>
                    <p>Your total stay: '.$days = calcDays($$Booking["checkIn"], $Booking["checkOut"]).' day/s</p>
                    <p>Your Total: '.calcCosts(calcDays($$Booking["checkIn"], $Booking["checkOut"]), $Booking["rate"]).' ZAR</p>
                    <br>
                    <br>
